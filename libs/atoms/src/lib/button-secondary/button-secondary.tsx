...
const focus =
  'focus:outline-none active:scale-95 active:bg-[#dcdfec] hover:bg-[#dcdfec]';
const defaultClass =
...
export const ButtonSecondary = ({ onHandleSubmit }: ButtonSecondary) => {
  return (
    <div className="flex mt-0 flex-end">
      <button
        onClick={onHandleSubmit}
        type="button"
        className={`${defaultClass} ${focus}`}
      >
        Continue
      </button>
    </div>
