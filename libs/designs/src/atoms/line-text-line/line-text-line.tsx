...
export const LineTextLine = ({ separatorText = 'Or', thinBorder = false }: LineTextLineProps) => {
  const separatorLeft = thinBorder ? lineStyle : `${lineStyle}  border-t-[2px] mr-2`;
  const separatorRight = thinBorder ? lineStyle : `${lineStyle}  border-t-[2px] ml-2`;
